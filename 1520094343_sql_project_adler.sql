...
SELECT (monthlymaintenance > 100) AS 'expensive', (monthlymaintenance < 100) AS 'cheap', name
FROM Facilities 
...
SELECT DISTINCT CONCAT(firstname, " ", surname) AS 'name', name AS 'court_used' FROM Facilities 
...
SELECT * 
FROM (
SELECT Facilities.name AS facility, CONCAT( Members.firstname,  ' ', Members.surname ) AS member_name, 
